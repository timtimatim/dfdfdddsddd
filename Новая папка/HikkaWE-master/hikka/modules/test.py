...
class TestMod(loader.Module):
    ...
    strings_ru = {
        ...
        "results_ping": (
            "<emoji document_id=5445284980978621387>🚀</emoji> <b>Скорость отклика\n"
            "Bampi:</b> <code>{}</code> <b>ms</b>\n<emoji"
            " <emoji document_id=5451732530048802485>⏳</emoji> <b>Прошло с последней"
            " перезагрузки: {}</b>"
        ),
        "ping_hint": (
